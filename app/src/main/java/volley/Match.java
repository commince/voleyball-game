...
class Match { //Отвечает за последовательность и наполнение событий матча
    ...
    private void createTeams() {
        team1 = createATeam();
        if(teamBuilder instanceof ManualTeamBuilder && userInput.askForSave()) new DBTeamSaver().saveTeam(team1);
        System.out.println("");
        ...
        if(teamBuilder instanceof ManualTeamBuilder && userInput.askForSave()) new DBTeamSaver().saveTeam(team2);
        System.out.println("");
    }
